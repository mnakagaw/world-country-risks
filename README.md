...
本プロジェクトの目的は「政権崩壊の予言」ではなく、国家が担うべき中核機能（R1:治安・R2:生活・R3:統治・R4:財政）が **どの方向に、どれくらい強く、平時から逸脱しているか**を国別に把握し、研究・政策・報道の初動判断を支援することにあります。
...
- **R-INDEX**：平時からのズレ（倍率）を中心に４大国家機能に対する「危機兆候」を見る（メイン）
